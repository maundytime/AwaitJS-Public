...
type ButtonValueStrict = ButtonValue & {
  render?: boolean;
};
...
type TimeValueStrict = TimeValue & {
  value?: never;
  date?: Date;
};
...
type FontDesign = "monospaced" | "rounded" | "serif" | "default" | "none";
type FontWeight =
  | "black"
  | 900
  | "heavy"
...
type BaseMods = {
  ...
  clipped?: boolean;
  clipShape?: NativeView | "none";
  colorInvert?: boolean;
  colorMultiply?: Color;
  compositingGroup?: boolean;
  contentShape?: NativeView | "none";
